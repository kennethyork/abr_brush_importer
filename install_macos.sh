#!/bin/bash
# ──────────────────────────────────────────────────────────────
# Install ABR Brush Importer plugin for Krita (macOS)
# ──────────────────────────────────────────────────────────────
set -e

KRITA_PYKRITA="$HOME/Library/Application Support/Krita/pykrita"
...
mkdir -p "$HOME/Library/Application Support/Krita/abr_brushes"
...
cp abr_brush_importer/bundle_writer.py   "$KRITA_PYKRITA/abr_brush_importer/"
